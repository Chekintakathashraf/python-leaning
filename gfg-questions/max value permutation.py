...
def max_sum_with_index(arr):
    ...
    for i in range(len(arr)):
        max_sum = (max_sum + arr[i] * i) % MOD  # Compute sum with modulo

    return max_sum

# Test cases
print(max_sum_with_index([5, 3, 2, 4, 1]))  # Output: 40
print(max_sum_with_index([1, 2, 3]))        # Output: 8
print(max_sum_with_index([7, 7, 7, 7]))     # Output: 42
